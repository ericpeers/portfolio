...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin/load_etf_holdings": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "CSV file (Symbol,Company,Weight)",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    }
        ...
        "/admin/securities/backfill_fundamentals": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Max securities to backfill (default 1000)",
                        "name": "count",
                        "in": "query"
                    }
                ],
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.PendingUser"
                            }
                        }
                    },
                    "401": {
    ...
    "definitions": {
        ...
        "models.BasketHolding": {
            ...
            "properties": {
                "buy_sell": {
                    "$ref": "#/definitions/models.BuySell"
                },
                "coverage_weight": {
                    "type": "number"
                },
        ...
        "models.BasketLevel": {
            ...
            "properties": {
                "holdings": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.BasketHolding"
                    }
                },
                "threshold": {
                    "type": "number"
        ...
        "models.CompareResponse": {
            ...
            "properties": {
                ...
                "baskets": {
                    "$ref": "#/definitions/models.BasketResult"
                },
                "performance_metrics": {
